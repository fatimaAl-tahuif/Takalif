...
شرح الكود بختصار:
فئة singleLinkedList:

تمثل قائمة مرتبطة أحادية الاتجاه تخزن عناصر من نوع E.
تتضمن وظائف مثل إضافة وحذف العناصر من البداية والنهاية، وحساب الحجم، والوصول إلى أول وآخر عنصر، وعكس ترتيب العناصر.
فئة Node:

تمثل عقدة في القائمة المرتبطة، وتتضمن قيمة العنصر ورابطًا إلى العقدة التالية.
كود main:

ينشئ قائمة جديدة ويضيف إليها 5 عناصر.
يطبع القائمة الأصلية.
يعكس ترتيب عناصر القائمة.
يطبع القائمة المعكوسة.
 */